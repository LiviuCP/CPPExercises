...
void CombinedSTLTests::testGatherAlgorithmMatrix_data()
{
    ...
    QTest::newRow("10a_1") << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << isNegativeInt << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << 1u;
    QTest::newRow("10a_2") << IntMatrix{-2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{0, 0} << isNegativeInt << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << 1u;
    QTest::newRow("10b_1") << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{1, 1} << isNegativeInt << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << 1u;
    QTest::newRow("10b_2") << IntMatrix{-2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << isNegativeInt << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << 1u;
    QTest::newRow("10c_1") << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{std::nullopt, std::nullopt} << isNegativeInt << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << 1u;
    QTest::newRow("10c_2") << IntMatrix{-2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{std::nullopt, std::nullopt} << isNegativeInt << IntMatrix{-2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << 1u;
    QTest::newRow("10d_1") << IntMatrix{2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << isNegativeInt << IntMatrix{2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{0, 0} << 0u;
    QTest::newRow("10d_2") << IntMatrix{2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{0, 0} << isNegativeInt << IntMatrix{2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{0, 0} << 0u;
    QTest::newRow("10e_1") << IntMatrix{2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{1, 1} << isNegativeInt << IntMatrix{2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{1, 1} << 0u;
    QTest::newRow("10e_2") << IntMatrix{2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << isNegativeInt << IntMatrix{2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{1, 1} << 0u;
    QTest::newRow("10f_1") << IntMatrix{2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{std::nullopt, std::nullopt} << isNegativeInt << IntMatrix{2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{0, 0} << 0u;
    QTest::newRow("10f_2") << IntMatrix{2, 1, 1} << MatrixPoint<int>{1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{std::nullopt, std::nullopt} << isNegativeInt << IntMatrix{2, 1, 1} << MatrixPoint<int>{0, 0} << MatrixPoint<int>{0, 0} << 0u;
