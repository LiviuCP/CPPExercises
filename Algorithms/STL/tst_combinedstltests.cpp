...
void CombinedSTLTests::testGatherAlgorithmStdVector_data()
{
    ...
    QTest::newRow("1") << mPrimaryIntVector << IntVectorDiff{0} << IntVectorDiff{14} << IntVectorDiff{4} << isNegativeInt << c_IntVectorRef1 << IntVectorDiff{2} << IntVectorDiff{7};
    QTest::newRow("2") << mPrimaryIntVector << IntVectorDiff{0} << IntVectorDiff{14} << IntVectorDiff{0} << isNegativeInt << c_IntVectorRef2 << IntVectorDiff{0} << IntVectorDiff{5};
    ...
    QTest::newRow("4") << mPrimaryIntVector << IntVectorDiff{2} << IntVectorDiff{10} << IntVectorDiff{5} << isNegativeInt << c_IntVectorRef4 << IntVectorDiff{3} << IntVectorDiff{6};
    QTest::newRow("5") << mPrimaryIntVector << IntVectorDiff{2} << IntVectorDiff{10} << IntVectorDiff{2} << isNegativeInt << c_IntVectorRef5_6_7 << IntVectorDiff{2} << IntVectorDiff{5};
    QTest::newRow("6") << mPrimaryIntVector << IntVectorDiff{2} << IntVectorDiff{10} << IntVectorDiff{1} << isNegativeInt << c_IntVectorRef5_6_7 << IntVectorDiff{2} << IntVectorDiff{5};
    QTest::newRow("7") << mPrimaryIntVector << IntVectorDiff{2} << IntVectorDiff{10} << IntVectorDiff{0} << isNegativeInt << c_IntVectorRef5_6_7 << IntVectorDiff{2} << IntVectorDiff{5};
    ...
    QTest::newRow("14") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{0} << IntVectorDiff{5} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("15") << mPrimaryIntVector << IntVectorDiff{4} << IntVectorDiff{4} << IntVectorDiff{4} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{4} << IntVectorDiff{4};
    QTest::newRow("16") << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{3} << IntVectorDiff{5} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{7};
    QTest::newRow("17") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{5} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("18") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{14} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("19") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{3} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("20") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{1} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("21") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{0} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("22") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{14} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("23") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{5} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("24") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{3} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("25") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{1} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("26") << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{3} << IntVectorDiff{0} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{14} << IntVectorDiff{14};
    QTest::newRow("27") << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{0} << IntVectorDiff{14} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{7};
    QTest::newRow("28") << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{0} << IntVectorDiff{9} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{7};
    QTest::newRow("29") << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{0} << IntVectorDiff{7} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{7};
    QTest::newRow("30") << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{0} << IntVectorDiff{3} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{7};
    QTest::newRow("31") << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{0} << IntVectorDiff{0} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{7} << IntVectorDiff{7};
    QTest::newRow("32") << mPrimaryIntVector << IntVectorDiff{5} << IntVectorDiff{8} << IntVectorDiff{6} << isNegativeInt << mPrimaryIntVector << IntVectorDiff{6} << IntVectorDiff{6};
    QTest::newRow("33") << mSecondaryIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{0} << isNegativeInt << mSecondaryIntVector << IntVectorDiff{0} << IntVectorDiff{0};
    QTest::newRow("34") << mSecondaryIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{1} << isNegativeInt << mSecondaryIntVector << IntVectorDiff{1} << IntVectorDiff{1};
    QTest::newRow("35") << mSecondaryIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{2} << isNegativeInt << mSecondaryIntVector << IntVectorDiff{2} << IntVectorDiff{2};
    QTest::newRow("36") << mThirdIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{0} << isNegativeInt << mThirdIntVector << IntVectorDiff{0} << IntVectorDiff{1};
    QTest::newRow("37") << mThirdIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{1} << isNegativeInt << mThirdIntVector << IntVectorDiff{0} << IntVectorDiff{1};
    QTest::newRow("38") << mThirdIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{2} << isNegativeInt << IntVector{14, -5} << IntVectorDiff{1} << IntVectorDiff{2};
    QTest::newRow("39") << mFourthIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{0} << isNegativeInt << IntVector{-14, 5} << IntVectorDiff{0} << IntVectorDiff{1};
    QTest::newRow("40") << mFourthIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{1} << isNegativeInt << mFourthIntVector << IntVectorDiff{1} << IntVectorDiff{2};
    QTest::newRow("41") << mFourthIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{2} << isNegativeInt << mFourthIntVector << IntVectorDiff{1} << IntVectorDiff{2};
    QTest::newRow("42") << mFifthIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{0} << isNegativeInt << mFifthIntVector << IntVectorDiff{0} << IntVectorDiff{2};
    QTest::newRow("43") << mFifthIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{1} << isNegativeInt << mFifthIntVector << IntVectorDiff{0} << IntVectorDiff{2};
    QTest::newRow("44") << mFifthIntVector << IntVectorDiff{0} << IntVectorDiff{2} << IntVectorDiff{2} << isNegativeInt << mFifthIntVector << IntVectorDiff{0} << IntVectorDiff{2};
    QTest::newRow("45") << IntVector{-5} << IntVectorDiff{0} << IntVectorDiff{1} << IntVectorDiff{0} << isNegativeInt << IntVector{-5} << IntVectorDiff{0} << IntVectorDiff{1};
    QTest::newRow("46") << IntVector{-5} << IntVectorDiff{0} << IntVectorDiff{1} << IntVectorDiff{1} << isNegativeInt << IntVector{-5} << IntVectorDiff{0} << IntVectorDiff{1};
    QTest::newRow("47") << IntVector{5} << IntVectorDiff{0} << IntVectorDiff{1} << IntVectorDiff{0} << isNegativeInt << IntVector{5} << IntVectorDiff{0} << IntVectorDiff{0};
    QTest::newRow("48") << IntVector{5} << IntVectorDiff{0} << IntVectorDiff{1} << IntVectorDiff{1} << isNegativeInt << IntVector{5} << IntVectorDiff{1} << IntVectorDiff{1};
    QTest::newRow("49") << IntVector{} << IntVectorDiff{0} << IntVectorDiff{0} << IntVectorDiff{0} << isNegativeInt << IntVector{} << IntVectorDiff{0} << IntVectorDiff{0};
}
...
void CombinedSTLTests::testGatherAlgorithmStdList_data()
{
    ...
    QTest::newRow("1") << mPrimaryIntList << size_t{0} << size_t{14} << size_t{4} << isNegativeInt << c_IntListRef1 << size_t{2} << size_t{7};
    QTest::newRow("2") << mPrimaryIntList << size_t{0} << size_t{14} << size_t{0} << isNegativeInt << c_IntListRef2 << size_t{0} << size_t{5};
    QTest::newRow("3") << mPrimaryIntList << size_t{0} << size_t{14} << size_t{14} << isNegativeInt << c_IntListRef3 << size_t{9} << size_t{14};
    QTest::newRow("4") << mPrimaryIntList << size_t{2} << size_t{10} << size_t{5} << isNegativeInt << c_IntListRef4 << size_t{3} << size_t{6};
    QTest::newRow("5") << mPrimaryIntList << size_t{2} << size_t{10} << size_t{2} << isNegativeInt << c_IntListRef5 << size_t{2} << size_t{5};
    ...
    QTest::newRow("15") << mPrimaryIntList << size_t{4} << size_t{4} << size_t{4} << isNegativeInt << mPrimaryIntList << size_t{4} << size_t{4};
    QTest::newRow("32") << mPrimaryIntList << size_t{5} << size_t{8} << size_t{6} << isNegativeInt << mPrimaryIntList << size_t{6} << size_t{6};
    QTest::newRow("33") << mSecondaryIntList << size_t{0} << size_t{2} << size_t{0} << isNegativeInt << mSecondaryIntList << size_t{0} << size_t{0};
    QTest::newRow("34") << mSecondaryIntList << size_t{0} << size_t{2} << size_t{1} << isNegativeInt << mSecondaryIntList << size_t{1} << size_t{1};
    QTest::newRow("35") << mSecondaryIntList << size_t{0} << size_t{2} << size_t{2} << isNegativeInt << mSecondaryIntList << size_t{2} << size_t{2};
    QTest::newRow("36") << mThirdIntList << size_t{0} << size_t{2} << size_t{0} << isNegativeInt << mThirdIntList << size_t{0} << size_t{1};
    QTest::newRow("37") << mThirdIntList << size_t{0} << size_t{2} << size_t{1} << isNegativeInt << mThirdIntList << size_t{0} << size_t{1};
    QTest::newRow("38") << mThirdIntList << size_t{0} << size_t{2} << size_t{2} << isNegativeInt << IntList{14, -5} << size_t{1} << size_t{2};
    QTest::newRow("39") << mFourthIntList << size_t{0} << size_t{2} << size_t{0} << isNegativeInt << IntList{-14, 5} << size_t{0} << size_t{1};
    QTest::newRow("40") << mFourthIntList << size_t{0} << size_t{2} << size_t{1} << isNegativeInt << mFourthIntList << size_t{1} << size_t{2};
    QTest::newRow("41") << mFourthIntList << size_t{0} << size_t{2} << size_t{2} << isNegativeInt << mFourthIntList << size_t{1} << size_t{2};
    QTest::newRow("42") << mFifthIntList << size_t{0} << size_t{2} << size_t{0} << isNegativeInt << mFifthIntList << size_t{0} << size_t{2};
    QTest::newRow("43") << mFifthIntList << size_t{0} << size_t{2} << size_t{1} << isNegativeInt << mFifthIntList << size_t{0} << size_t{2};
    QTest::newRow("44") << mFifthIntList << size_t{0} << size_t{2} << size_t{2} << isNegativeInt << mFifthIntList << size_t{0} << size_t{2};
    QTest::newRow("45") << IntList{-5} << size_t{0} << size_t{1} << size_t{0} << isNegativeInt << IntList{-5} << size_t{0} << size_t{1};
    QTest::newRow("46") << IntList{-5} << size_t{0} << size_t{1} << size_t{1} << isNegativeInt << IntList{-5} << size_t{0} << size_t{1};
    QTest::newRow("47") << IntList{5} << size_t{0} << size_t{1} << size_t{0} << isNegativeInt << IntList{5} << size_t{0} << size_t{0};
    QTest::newRow("48") << IntList{5} << size_t{0} << size_t{1} << size_t{1} << isNegativeInt << IntList{5} << size_t{1} << size_t{1};
    QTest::newRow("49") << IntList{} << size_t{0} << size_t{0} << size_t{0} << isNegativeInt << IntList{} << size_t{0} << size_t{0};
}
