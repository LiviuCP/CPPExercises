...
AlternativeRedBlackTree::AlternativeRedBlackTree(const std::string& nullValue)
...
*/
AlternativeRedBlackTree::AlternativeRedBlackTree(const std::vector<int>& inputKeys, const std::string& defaultValue, const std::string& nullValue)
    : AlternativeBinarySearchTree{nullValue}
{
    if (inputKeys.size() != 0 && defaultValue != nullValue)
    {
        ...
        {
            spRBNode const addedNode{dynamic_pointer_cast<RedBlackNode>(AlternativeRedBlackTree::_doAddOrUpdateNode(*it, defaultValue))};

            if (AlternativeBinarySearchTree::sLoggingEnabled && addedNode)
            {
...
AlternativeRedBlackTree::AlternativeRedBlackTree(const AlternativeRedBlackTree& sourceTree)
    : AlternativeBinarySearchTree{sourceTree.m_NullValue} // the "empty tree" base constructor is called for the above mentioned reasons
{
    _copyTreeNodes(sourceTree);
}

AlternativeRedBlackTree::AlternativeRedBlackTree(AlternativeRedBlackTree&& sourceTree)
{
...
AlternativeRedBlackTree& AlternativeRedBlackTree::operator=(const AlternativeRedBlackTree& sourceTree)
{
    if (this != &sourceTree)
    {
        if (m_Root)
...
AlternativeRedBlackTree& AlternativeRedBlackTree::operator=(AlternativeRedBlackTree&& sourceTree)
{
    if (this != &sourceTree)
    {
        if (m_Root)
...
void AlternativeRedBlackTree::printTree() const
{
    ...
    if (AlternativeBinarySearchTree::sLoggingEnabled && nodesArray.size() == 0)
    {
...
*/
AlternativeRedBlackTree::spNode AlternativeRedBlackTree::_doAddOrUpdateNode(int key, const std::string& value)
{
    spRBNode addedNode{dynamic_pointer_cast<RedBlackNode>(AlternativeBinarySearchTree::_doAddOrUpdateNode(key, value))};
...
*/
AlternativeRedBlackTree::spNode AlternativeRedBlackTree::_removeSingleChildedOrLeafNode(spNode const nodeToRemove)
{
    ...
    if (rbNodeToRemove)
    {
        ...
        spRBNode const replacingNode{dynamic_pointer_cast<RedBlackNode>(AlternativeBinarySearchTree::_removeSingleChildedOrLeafNode(nodeToRemove))};
...
AlternativeRedBlackTree::spNode AlternativeRedBlackTree::_createNewNode(int key, const std::string& value)
{
    return std::make_shared<RedBlackNode>(key, value);
}

std::string AlternativeRedBlackTree::_getNodeAsString(spNode const node, bool isValueRequired) const
{
    ...
    if (rbNode)
    {
        result = AlternativeBinarySearchTree::_getNodeAsString(rbNode, isValueRequired);
...
AlternativeRedBlackTree::RedBlackNode::RedBlackNode(int key, std::string value)
    : Node{key, value}
    , m_IsBlack{false}  // all newly nodes are red by default as this is the convention for adding them to the red-black-tree
{
}

void AlternativeRedBlackTree::RedBlackNode::setBlack(bool isBlackRequired)
{
...
bool AlternativeRedBlackTree::RedBlackNode::isBlack() const
{
    return m_IsBlack;
}
