...
AlternativeAVLTree::AlternativeAVLTree(const std::string& nullValue)
...
*/
AlternativeAVLTree::AlternativeAVLTree(const std::vector<int>& inputKeys, const std::string& defaultValue, const std::string& nullValue)
    : AlternativeBinarySearchTree{nullValue}
{
...
AlternativeAVLTree::AlternativeAVLTree(const AlternativeAVLTree& sourceTree)
...
AlternativeAVLTree::AlternativeAVLTree(AlternativeAVLTree&& sourceTree)
{
...
AlternativeAVLTree& AlternativeAVLTree::operator=(const AlternativeAVLTree& sourceTree)
{
    if (this != &sourceTree)
    {
        if (m_Root)
...
AlternativeAVLTree& AlternativeAVLTree::operator=(AlternativeAVLTree&& sourceTree)
{
    if (this != &sourceTree)
    {
        if (m_Root)
...
*/
AlternativeAVLTree::spNode AlternativeAVLTree::_doAddOrUpdateNode(int key, const std::string& value)
{
    spAVLNode const addedNode{dynamic_pointer_cast<AVLNode>(AlternativeBinarySearchTree::_doAddOrUpdateNode(key, value))};
...
*/
AlternativeAVLTree::spNode AlternativeAVLTree::_removeSingleChildedOrLeafNode(spNode const nodeToRemove)
{
    if (nodeToRemove)
    {
        ...
        (void)AlternativeBinarySearchTree::_removeSingleChildedOrLeafNode(nodeToRemove);
...
AlternativeAVLTree::spNode AlternativeAVLTree::_createNewNode(int key, const std::string& value)
{
    return std::make_shared<AVLNode>(key, value);
}

void AlternativeAVLTree::_updateAncestorHeights(spAVLNode const node)
{
    if (node)
    {
...
AlternativeAVLTree::spAVLNode AlternativeAVLTree::_balanceSubtree(spAVLNode const grandparent, spAVLNode const parent, spAVLNode const child)
{
...
bool AlternativeAVLTree::AVLNode::isBalanced() const
{
    spAVLNode const leftChild{dynamic_pointer_cast<AVLNode>(getLeftChild())};
    spAVLNode const rightChild{dynamic_pointer_cast<AVLNode>(getRightChild())};
...
AlternativeAVLTree::spAVLNode AlternativeAVLTree::AVLNode::getGreaterHeightChild() const
{
    spAVLNode const leftChild{dynamic_pointer_cast<AVLNode>(getLeftChild())};
    spAVLNode const rightChild{dynamic_pointer_cast<AVLNode>(getRightChild())};
