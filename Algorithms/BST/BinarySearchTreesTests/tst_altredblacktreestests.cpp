...
using RBTIterator = AlternativeRedBlackTree::InOrderForwardIterator;

class AltRedBlackTreesTests : public QObject
{
    Q_OBJECT

public:
    AltRedBlackTreesTests();
    ~AltRedBlackTreesTests();
...
private:
    ...
    AlternativeRedBlackTree* mpSearchTree;
    AlternativeRedBlackTree* mpAuxSearchTree;
};

AltRedBlackTreesTests::AltRedBlackTreesTests()
...
void AltRedBlackTreesTests::init()
{
    QVERIFY(nullptr == mpSearchTree && nullptr == mpAuxSearchTree);
}

void AltRedBlackTreesTests::cleanup()
{
    _resetTreeObjects();
    AlternativeBinarySearchTree::enableLogging(false);
}

void AltRedBlackTreesTests::testAddNodes()
{
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 8, -1, 2, -2, 7, 0, -9, 16, 14, -23, 17, -16, -12, 19, -15}, scDefaultValue, scCustomNullValue};
    ...
    delete mpSearchTree;
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-23, -16, -15, -12, -9, -5, -2, -1, 0, 2, 7, 8, 14, 16, 17, 19}, scDefaultValue};
    ...
    delete mpSearchTree;
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{19, 17, 16, 14, 8, 7, 2, 0, -1, -2, -5, -9, -12, -15, -16, -23}, scDefaultValue};
    ...
    delete mpSearchTree;
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-23, 19, -16, 17, -15, 16, -12, 14, -9, 8, -5, 7, -2, 2, -1, 0}, scDefaultValue, scCustomNullValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 2, -3, 4, 0, 1}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 2, -3, 2, 4, 0, 1}, scDefaultValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 2, -3, 4, 0, 1}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, -3, 2, 4, 0, 1}, scDefaultValue, scCustomNullValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 2, -3, 4, 0, 1}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 2, -3, 4, 1, 0}, scDefaultValue, scCustomNullValue};

    QVERIFY(*mpSearchTree != *mpAuxSearchTree);

    _resetTreeObjects();

    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-3, -5, 2, 4, 0, 1}, scDefaultValue, scDefaultNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-3, 2, -5, 4, 0, 1}, scDefaultValue, scCustomNullValue};

    QVERIFY(*mpSearchTree == *mpAuxSearchTree);

    _resetTreeObjects();

    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{}, scDefaultValue};
...
void AltRedBlackTreesTests::testRemoveNodes()
{
    bool nodeDeleted{false};

    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 8, -1, 2, -2, 7, 0, -9, 16, 14, -23, 17, -16, -12, 19, -15}, scDefaultValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{*mpSearchTree};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 8, -1, 2, -2, 7, 0, -9, 16, 14, -23, 17, -16, -12, 19, -15}, scDefaultValue, scCustomNullValue};
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{19, 17, 16, 14, 8, 7, 2, 0, -1, -2, -5, -9, -12, -15, -16, -23}, scDefaultValue, scCustomNullValue};
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-3, -5, 2}, scDefaultValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-3, -5, 2}, scDefaultValue, scCustomNullValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-1, 3, 2, 4, -2}, scDefaultValue, scCustomNullValue};
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-1, 3, 2, 4, -2}, scDefaultValue};
...
void AltRedBlackTreesTests::testUpdateNodeValue()
{
    mpSearchTree = new AlternativeRedBlackTree;
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-5, 8, -1, 2, -2, 7, 0, -9, 16, 14, -23, 17, -16, -12}, scDefaultValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{16, -9, 14, 7, -23, 17, -16, -12}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{-2, 5, 4, 0, -1}, scDefaultValue};
...
void AltRedBlackTreesTests::testMoveSemantics()
{
    mpSearchTree = new AlternativeRedBlackTree;
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{std::move(*mpSearchTree)};
    ...
    *mpSearchTree = std::move(*mpAuxSearchTree);
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{-2, 5, 4, 0, -1}, scDefaultValue, scCustomNullValue};
...
void AltRedBlackTreesTests::testMergeTrees()
{
    mpSearchTree = new AlternativeRedBlackTree;
    ...
    const AlternativeRedBlackTree searchTreeCopy{*mpSearchTree};
    const AlternativeRedBlackTree searchTreeAuxCopy{*mpAuxSearchTree};
    ...
    const AlternativeRedBlackTree mainTreeAfterFirstMerge{*mpSearchTree};
    ...
    *mpAuxSearchTree = searchTreeAuxCopy;
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{16, -9, 14, 7, -23, 17, -16, -12}, scDefaultValue, scCustomNullValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{5, 10, -2, 9, 4, 2, 7, -8}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{16, -9, 14, 7, -23, 17, -16, -12, 1}, scDefaultValue, scDefaultNullValue};
    ...
    mpSearchTree = new AlternativeRedBlackTree{std::vector<int>{5, 10, -2, 9, 4, 2, 7, -8}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new AlternativeRedBlackTree{std::vector<int>{16, -9, 14, 7, -23, 17, -16, -12, 1}, scDefaultValue, scCustomNullValue + "1"};
    mpSearchTree->addOrUpdateNode(9, "abc");
    mpAuxSearchTree->addOrUpdateNode(7, "xyz");
...
void AltRedBlackTreesTests::testInOrderForwardIterators()
{
    mpSearchTree = new AlternativeRedBlackTree;
    ...
    mpAuxSearchTree = new AlternativeRedBlackTree{"NullVal"};
...
void AltRedBlackTreesTests::testPrintTree()
{
...
void AltRedBlackTreesTests::_resetTreeObjects()
{
    delete mpSearchTree;
    mpSearchTree = nullptr;
...
QTEST_APPLESS_MAIN(AltRedBlackTreesTests)

#include "tst_altredblacktreestests.moc"
