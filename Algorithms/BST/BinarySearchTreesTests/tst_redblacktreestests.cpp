...
void RedBlackTreesTests::testMergeTrees()
{
    ...
    *mpAuxSearchTree = searchTreeAuxCopy;
    ...
    mpSearchTree = new RedBlackTree{std::vector<int>{5, 10, -2, 9, 4, 2, 7, -8}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new RedBlackTree{std::vector<int>{16, -9, 14, 7, -23, 17, -16, -12, 1}, scDefaultValue, scDefaultNullValue};
    ...
    mpSearchTree = new RedBlackTree{std::vector<int>{5, 10, -2, 9, 4, 2, 7, -8}, scDefaultValue, scCustomNullValue};
    mpAuxSearchTree = new RedBlackTree{std::vector<int>{16, -9, 14, 7, -23, 17, -16, -12, 1}, scDefaultValue, scCustomNullValue + "1"};
    mpSearchTree->addOrUpdateNode(9, "abc");
    mpAuxSearchTree->addOrUpdateNode(7, "xyz");
