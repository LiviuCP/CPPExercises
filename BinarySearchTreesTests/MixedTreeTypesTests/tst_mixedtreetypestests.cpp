...
const std::string MixedTreeTypesTests::scDefaultValue{"DF"};
const std::string MixedTreeTypesTests::scDefaultNullValue{""};
const std::string MixedTreeTypesTests::scCustomNullValue{"NULL"};
const std::string MixedTreeTypesTests::scEmptyTreeString{""};
...
void MixedTreeTypesTests::testMergeDifferentSearchTrees()
{
    ...
    QVERIFY(_areExpectedTreeValuesMet(mpSearchTree, scEmptyTreeString, 0, true));
    QVERIFY(_areExpectedTreeValuesMet(mpAuxSearchTree, "-1:c3:ROOT:BK/-5:a1_1:-1:BK/8:b2:-1:BK/-16:m13:-5:RD/-2:e5:-5:BK/2:d4:8:BK/16:i9_1:8:BK/-23:k11:-16:BK/-9:h8:-16:BK/0:g7_1:2:RD/7:f6:2:RD/14:j10:16:RD/17:l12:16:RD/-12:n14:-9L:RD", 14, true));
    ...
    QVERIFY(_areExpectedTreeValuesMet(mpSearchTree, scEmptyTreeString, 0, true));
    QVERIFY(_areExpectedTreeValuesMet(mpAuxSearchTree, "-1:c3:ROOT/-9:h8:-1/8:b2:-1/-16:m13:-9/-5:a1_1:-9/2:d4:8/16:i9_1:8/-23:k11:-16/-12:n14:-16/-2:e5:-5R/0:g7_1:2/7:f6:2/14:j10:16/17:l12:16", 14, true));
...
bool MixedTreeTypesTests::_areExpectedTreeValuesMet(const BinarySearchTree *searchTree, const std::string &treeString, int treeSize, bool areNodeValuesConsidered) const
{
